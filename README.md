...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-22 11:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/bb7d64d1-fb86-44fd-b8db-998fba3d6d05.git
$ cd bb7d64d1-fb86-44fd-b8db-998fba3d6d05
```
